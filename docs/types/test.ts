...
// Attached to the main export is a `main` method which returns a number...
{
	...
	sapxsumkbn.main( x.length, 5.0, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	sapxsumkbn.main( '10', 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( true, 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( false, 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( null, 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( undefined, 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( [], 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( {}, 5.0, x, 1 ); // $ExpectError
	sapxsumkbn.main( ( x: number ): number => x, 5.0, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a number...
{
	...
	sapxsumkbn.main( x.length, '10', x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, true, x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, false, x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, null, x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, undefined, x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, [], x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, {}, x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, ( x: number ): number => x, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a Float32Array...
{
	...
	sapxsumkbn.main( x.length, 5.0, 10, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, '10', 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, true, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, false, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, null, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, undefined, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, [], 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, {}, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fourth argument which is not a number...
{
	...
	sapxsumkbn.main( x.length, 5.0, x, '10' ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, true ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, false ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, null ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, undefined ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, [] ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, {} ); // $ExpectError
	sapxsumkbn.main( x.length, 5.0, x, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	sapxsumkbn.main(); // $ExpectError
	sapxsumkbn.main( x.length ); // $ExpectError
	sapxsumkbn.main( x.length, x ); // $ExpectError
	sapxsumkbn.main( x.length, x, 1 ); // $ExpectError
	sapxsumkbn.main( x.length, x, 1, 10, 2 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	sapxsumkbn.ndarray( x.length, x ); // $ExpectError
	sapxsumkbn.ndarray( x.length, x, 1 ); // $ExpectError
	sapxsumkbn.ndarray( x.length, x, 1, 0 ); // $ExpectError
	sapxsumkbn.ndarray( x.length, x, 1, 0, 10, 2 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	sapxsumkbn.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	sapxsumkbn.Module( '10' ); // $ExpectError
	sapxsumkbn.Module( true ); // $ExpectError
	sapxsumkbn.Module( false ); // $ExpectError
	sapxsumkbn.Module( null ); // $ExpectError
	sapxsumkbn.Module( undefined ); // $ExpectError
	sapxsumkbn.Module( [] ); // $ExpectError
	sapxsumkbn.Module( {} ); // $ExpectError
	sapxsumkbn.Module( ( x: number ): number => x ); // $ExpectError
}
...
// The `Module` constructor returns a module instance having a `main` method which returns a number...
{
	...
	const mod = sapxsumkbn.Module( mem );
